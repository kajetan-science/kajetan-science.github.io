...
date: 2026-05-16
summary: "From a children's game about big numbers to bit-packed integer cell IDs on a sphere — why DGGS indexing exists and how it manages to be fast."
tags: []
jupyter: volcan
---
...
```{python}
#| code-fold: true
#| fig-cap: "A quadtree at three levels of refinement, with each cell labelled by its base-4 path from the root."
...
```{python}
#| code-fold: true
#| fig-cap: "Cells of a level-3 quadtree connected in path order. The curve fills the square in a recursive Z shape."
import numpy as np
